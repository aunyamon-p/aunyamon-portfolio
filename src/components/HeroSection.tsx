            ...
            <div className="animate-fade-in">
             ...
             <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button
                  ...
                  className="w-full sm:w-[220px] h-[56px] px-6 py-4 bg-tech-cyan text-tech-slate font-semibold rounded-full hover:bg-tech-cyan/90 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-tech-cyan/25 flex items-center justify-center"
                >
                ...
                >
                  <a href="https://github.com/aunyamon-p" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                    <span className="truncate">{currentContent.github}</span>
                    <svg className="ml-2 w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
